...
<div class="container mt-5" style="margin-top:14%;">
            ...
            <div class="card" style="background:none;border:none;">
              ...
              style="border-top-left-radius:100px;border-top-right-radius:100px;"  >BOOK NOW</div>
                ...
                <div class="tab-content"><div class="tab-pane show active" id="personal-det">
                            ...
                            style="
                         border:none;">
                    <form action="pacbook.php" class="needs-validation" method="post" data-bs-spy="scroll" novalidate>
<!--Personal details-->                        
<?php
session_start();
include 'db.php';
...
?>                                 
                     ...
                     style="border-bottom-left-radius:50px;border-bottom-right-radius:50px;">
                        <div class="row">
                        <div class="col-6">
                        <a class="btn-block btn btn-secondary" href="religionpackages.php"style="font-weight:bold;">
 ...
 <div class="row justify-content-center">
   ...
   <div class="row justify-content-center">
    ...
    <div class="col-lg-4 col-6">
        ...
        <option value=""></option>
        <?php
        $sqlt = "select *from religion";
        $res = $con->query($sqlt); 
        while($rows=$res->fetch_array())
        {
            ?>
            
            <option value="<?php echo $rows[1],' ',$rows[4],$rows[2];?>"><?php echo $rows[1];?></option>
        <?php
        }
        ?>    
        </select> 
...
<div class="col-2">
<input type="radio" name="tran" value="Car" onchange="fun()" required="" id="car" class="form-control transport" aria-placeholder="Transportaion">
</div> 
</div> 
<div class="row justify-content-center">
...
<script>
    ...
    //cosole.log("package amount "+paca);
