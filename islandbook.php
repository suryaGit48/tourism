...
?>                            
                               ...
                               <div class="row justify-content-center">
                                ...
                                <div class="col-6">
                                    <input type="email" name="email" readonly value="<?php echo $row[2]; ?>" id="emaili" class="form-control">     
...
?>                                       
                     ...
                     style="border-bottom-left-radius:50px;border-bottom-right-radius:50px;">
                        <div class="row">
                        <div class="col-6">
                        <a class="btn-block btn btn-secondary" href="islandpackages.php"style="font-weight:bold;">
...
<!--From and To location-->
 <div class="row justify-content-center">
    ...
    <div class="col-lg-4 col-6">
        ...
        {
        ?>    
            <option value="<?php echo $row[0]; $toloca=$row[0]; ?>"><?php echo $row[0]; ?></option>  
        <?php
        }
        ?>
            </select>
