        ...
        <a class="nav-link dropdown-toggle navli drop-left"  role="button" aria-haspopup="true" aria-expanded="false" href="#"
         id="dropdownMenuLink" data-toggle="dropdown">packages</a> 
          <div class="dropdown-menu dropdown-menu-left" aria-labelledby="#dropdownMenuLink">
             <a href="packages.html" class="dropdown-item">popular packages</a>
             <a href="#" class="dropdown-item">Friendly packages</a>
             <a href="packages2.html" class="dropdown-item">Local packages</a>
           </div>
...
<script>
  ...
  <div class="carousel-item">
    <img src="./img/bga2.jpg" alt="train" class="d-block w-100 h-50 img-fluid">
</div></div>
...
<div class="container text-center">
      <div class="row justify-content-center">
        <h2 class="text-danger my-1"> Friendly packages </h2> 
      </div>
       <div class="row justify-content-center">
        <a href="packages.html" class="mt-1 text-dark vd"><b>-------------popular pacages-----------</b></a>
       </div>
    </div>
...
?>
            <div class="col-lg-4">
                <div class="card">
                    <div class="pacim">
                        <img src="./image/<?php echo $rows[3]; ?>" alt="leaning" class="card-img-top pacima">
                    </div>
                    <div class="card-body conbot">
                        <h4 class="text-center card-title"><?php echo $rows[0]; ?></h4>
                        <h5 class="text-danger"><i class="fas fa-map-marker-alt text-primary"></i> Location:<?php echo $rows[0]; ?></h5>

                        <h5 class="text-danger"> <i class="fas fa-clock text-primary"></i> Duration:<?php echo $rows[1]; ?></h5>
                        <h5 class="text-danger"> <i class="fas fa-rupee-sign text-primary"></i> Price :<i class="fas fa-rupee-sign text-danger"></i>
                            <?php echo $rows[2]; ?></h5>
                    </div>
                    <div class="card-footer conbot">
                        <button class="btn btn-primary ml-3"><a href="http://hohogoa.com/goa-tourism/sightseeing-places-to-visit-goa.aspx" class="text-light ab">About us</a></button>
                        <button class="btn btn-primary"> <a href="book.html" class="text-light">Book now</a></button>
                    </div>
                </div>
            </div>
<?php
