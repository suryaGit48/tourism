            ...
            <div class="card" style="background:none;border:none;margin-top:10%;">
              ...
              style="border-top-left-radius:100px;border-top-right-radius:100px;"  >BOOK NOW</div>
                ...
                <div class="tab-content"><div class="tab-pane show active" id="personal-det">
                            ...
                            style="
                         border:none;">
                    <form action="beabook.php" class="needs-validation" method="post" data-bs-spy="scroll" novalidate>
<!--Personal details-->         
<?php 
$count=0;
...
?>                
                                    ...
                                    <div class="col-6">
                                        <input type="text" name="name" id="nav" readonly required="" class="form-control" value="<?php echo $usname; ?>">
...
?>                                  
                     ...
                     style="border-bottom-left-radius:50px;border-bottom-right-radius:50px;">
                        <div class="row">
                        <div class="col-6">
                        <a class="btn-block btn btn-secondary" href="beachpackages.php"style="font-weight:bold;">
...
<!--From and To location-->
 <div class="row justify-content-center">
    ...
    <div class="col-lg-4 col-6">
        <select name="fromLocation" oninput="from();" onchange="fun();flight();from()" required="" id="fromLocation" aria-placeholder="From location" class="form-control"> 
        <?php
   ...
   <div class="row justify-content-center">
    ...
    <div class="col-lg-4 col-6">
        ...
        <option value=""></option>
        <?php
        $sqlt = "select location,country,amount from beach";
        $res = $con->query($sqlt); 
        while($rows=$res->fetch_array())
        {
            ?>
            
            <option value="<?php echo $rows[0],' ',$rows[2],$rows[1];?>"> <?php echo $rows[0];?></option>
        <?php
        }
        ?>    
        </select> 
...
<div class="col-2 fli">  <input type="radio" name="tran" required="" value="Flight" onchange="fun()"  id="flig" class="form-control flight transport" aria-placeholder="Transportaion">       
</div>
<div class="col-2"> 
<input type="radio" name="tran" value="Train" onchange="fun()"required="" id="tra" class="form-control transport" aria-placeholder="Transportaion">
</div>
<div class="col-2"> 
<input type="radio" name="tran" value="Bus" onchange="fun()" required="" id="bus" class="form-control transport" aria-placeholder="Transportaion">
</div>
<div class="col-2">
<input type="radio" name="tran" value="Car" onchange="fun()" required="" id="car" class="form-control transport" aria-placeholder="Transportaion" checked>
</div> 
</div> 
<div class="row justify-content-center">
