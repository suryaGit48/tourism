...
<!--Personal details-->                        
                                    ...
                                    <div class="col-6">
                                        <input type="text" name="name" id="nav" oninput="validate()" required="" class="form-control" placeholder="Booking user Name">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-6">
                                    <input type="number" name="phones" id="Phone" class="form-control" oninput="phonenumber()" placeholder="phone number">
                               ...
                               <div class="row justify-content-center">
                                ...
                                <div class="col-6">
                                    <input type="email" name="email" oninput="evalidate()" id="emaili" class="form-control" placeholder="youawesome@gmail.com">     
