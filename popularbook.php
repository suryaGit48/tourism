...
?>                                        
                     ...
                     style="border-bottom-left-radius:50px;border-bottom-right-radius:50px;">
                        <div class="row">
                        <div class="col-6">
                        <a class="btn-block btn btn-secondary" href="popularpackages.php"style="font-weight:bold;">
 ...
 <div class="row justify-content-center">
   ...
   <div class="row justify-content-center">
    ...
    <div class="col-lg-4 col-6">
        ...
        <?php
        $sqlt = "select *from poppack";
        $res = $con->query($sqlt); 
        while($rows=$res->fetch_array())
        {
            ?>
            <option value="<?php echo $rows[1],' ',$rows[4];?>"><?php echo $rows[1];?></option>
        <?php
        }
        ?>    
        </select> 
