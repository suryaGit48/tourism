      ...
      <li class="nav-item dropdown" id="hover-dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-left" aria-labelledby="#dropdownMenuLink">
          <a href="popularpackages.php" class="dropdown-item">popular packages</a>
             ...
             <a href="#" class="dropdown-item">Island packages</a>
...
<div class="container text-center">
      <div class="row justify-content-center">
        <h2 class="text-danger my-1"> ISLAND PACKAGES </h2> 
      </div>
      <h6><a href="islandamount.php">Click Here  <i class="fas fa-arrow-right"></i></a>    view package amount details</h6>
    </div><br>

<?php
include 'db.php';
$sqls = "select *from island";
            ...
            <div class="col-lg-4">
                ...
                <div class="pacim">  <div class="card-body pacbg" style="background-image:url('./image/<?php echo $rows[4]; ?>');
                    background-size:cover;border-radius:20px;">
                       ...
                       <h5 class="text-center"> <a href="islandbook.php" style="font-weight:bold;" class="bg-waring text-light text-center"> 
