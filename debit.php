    ...
    <div class="row mt-5 justify-content-center">
      <div class="col-lg-5 col-12 mt-5">
          <div class="card">
            ...
            <h6>Mode of Payment <b class="ml-2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b>DEBIT CARD</h6>
              <h6>Card Type    <b class="ml-5" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b><?php echo $drtype; ?></h6>
              <h6>Credit Card NO  <b class="ml-5" >:</b><?php echo $drnum; ?></h6>
              <h6>Card Holder Name  <b class="ml-2" >&nbsp;&nbsp;&nbsp;&nbsp;:</b> <?php echo $drname; ?></h6>
              <h6>CVV NO  <b class="ml-5" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b> <?php echo $drcvv; ?></h6>
              <h6>Expiry Date  <b class="ml-5" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b> <?php echo $dmont.'/'.$dye; ?></h6>
            </div>
