      ...
      <li class="nav-item dropdown" id="hover-dropdown">
        <a class="nav-link dropdown-toggle navli drop-left"  role="button" aria-haspopup="true" aria-expanded="false" href="#"
         id="dropdownMenuLink" data-toggle="dropdown">packages</a> 
          ...
          <a href="#" class="dropdown-item">popular packages</a>
...
<div class="container text-center">
      <div class="row justify-content-center">
        <h2 class="text-danger my-1"> POPULAR PACKAGES </h2><br>
        
      </div><h6><a href="amount.php">Click Here  <i class="fas fa-arrow-right"></i></a>    view package amount details</h6>
            ...
            <div class="col-lg-4 col-12">
                ...
                <div class="pacim">  <div class="card-body pacbg" style="background-image:url('./image/<?php echo $rows[5]; ?>');
                    background-size:cover;border-radius:20px;">
                       ...
                       <h5 class="text-center"> <a href="popularbook.php" style="font-weight:bold;" class="bg-warning text-light text-center"> 
...
<footer class="bg-dark">
<div class="row justify-content-center">
      <div class="col-lg-3 col-10 col-md-7"><br>
